...
intervalmean2_wk<-sapply(split(wkspit[[1]]$steps,as.factor(wkspit[[1]]$interval)),mean,na.rm=TRUE) intervalmean2_wend<-sapply(split(wkspit[[2]]$steps,as.factor(wkspit[[2]]$interval)),mean,na.rm=TRUE)
